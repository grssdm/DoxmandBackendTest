        ...
        */
        ...
        public IEnumerable<Product> GetBasicProducts()
        {
            List<Product> basicProducts = new List<Product> {
                ...
                new Product("Doxmand Nomus 360 ultrahangos rágcsálóriasztó", 4, Product.AlarmType.Rodent, "https://doxmand.hu/wp-content/uploads/2021/06/Nomus-Plus-360psd.jpg", "", -1, "https://firebasestorage.googleapis.com/v0/b/asp-testing-f6b86.appspot.com/o/MapIcons%2FNomusPlus360RR.png?alt=media"),
