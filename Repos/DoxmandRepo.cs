...
namespace DoxmandAPI.Repos
{
    public class DoxmandRepo : IUsersRepo, IProductRepo, IPlanRepo
    {
        ...
        public User AddUserToFirebase(UserDTO userDto)
        {
            ...
            User user = new User(userDto.Email, CommonMethods.EncryptPassword(userDto.Password), userDto.Name);
        ...
        public Product AddProductToFirebase(ProductDTO productDto)
        {
            ...
            Product product = new Product(productDto.Name, productDto.SpeakerNumber, productDto.Type, productDto.SerialNumber, productDto.PictureUrl);
        ...
        public Plan AddPlanToFirebase(Dictionary<string, Coord> placedProducts)
        {
            _client = new FirebaseClient(_config);

            Plan plan = new Plan(placedProducts);
